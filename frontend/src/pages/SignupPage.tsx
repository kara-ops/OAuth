...
export const SignupPage: React.FC = () => {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      const res = await apiClient.post('/auth/create-user', { email, password });
    ...
    <div className="flex items-center justify-center flex-1 w-full max-w-md mx-auto">
      <Card className="w-full">
        ...
        <div className="flex items-center my-6">
          ...
          <span className="px-3 subtitle text-sm">or sign up with</span>
          <div className="flex-1 border-t"></div>
        </div>

        <Button variant="outline" className="w-full gap-2" onClick={handleGoogleLogin} isLoading={isGoogleLoading}>
